...
There are 6 course modules: R Basics, Working with Data, Plotting Data, Data Manipulation, Statistics in R, and Functions. The following sections were created following the Understanding by Design (i.e., Backwards Design) framework developed by Wiggins and McTighe. 
